...
Note: Due to the time it takes for data-scraping (roughly 10 hours), it is recommended to load the .RData files. The final dataset used in the analysis can be found here in .csv format: https://dl.dropboxusercontent.com/u/105063416/nhl_shots_2016.csv
...
This block of code below scrapes the data we need for this analysis. It takes roughly 10 hours to execute, that's why "eval" is set to FALSE in this RMarkdown File.
...
(https://dl.dropboxusercontent.com/u/105063416/MasterPBP2016.RData)
...
(https://dl.dropboxusercontent.com/u/105063416/MasterRoster2016.RData)
...
setwd("C:\\Users\\WhiteWhale\\Dropbox\\CSCI-107\\Hockey Project")
...
### We set the minimum probability of scoring as 1%, this will be used later
...
...and that is why this model has tremendous value in the world of fantasy sports - a once popular office hobby that turned into a billion dollar industry - where rosters are adjusted weekly to take advantage of players' streaks.
